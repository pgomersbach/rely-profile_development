...
#
# Usage:
# Ubuntu / Debian: wget https://raw.githubusercontent.com/relybv/puppet-module-skeleton/master/skeleton/files/bootstrap.sh; bash bootstrap.sh
#
# Red Hat / CentOS: curl https://raw.githubusercontent.com/relybv/puppet-module-skeleton/master/skeleton/files/bootstrap.sh -o bootstrap.sh; bash bootstrap.sh
