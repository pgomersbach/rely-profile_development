...
# This script installs puppet 3.x and deploy the manifest using puppet apply -e "include profile_development"
# Usage:
# <powershell>
# Set-ExecutionPolicy Unrestricted -Force
# icm $executioncontext.InvokeCommand.NewScriptBlock((New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/relybv/profile_development/master/files/bootme.ps1')) -ArgumentList ("profile_development")
#</powershell>


  param(
    [string]$role = "profile_development",
  )

  $puppet_source = "https://github.com/relybv/rely-profile_development.git"
